...
<html lang="en">
    ...
    <div class="container">
        ...
        <table class="table">
            ...
            <tbody>
                <?php foreach ($subscriberBooks as $subscriberBook) : ?>
                <tr>
                    <td><?= $subscriberBook['id'] ?></td>
                    <td><?= $subscriberBook['firstName'] ?></td>
                    <td><?= $subscriberBook['lastName'] ?></td>
                    <td><?= $subscriberBook['title'] ?></td>
                    <td><?= $subscriberBook['author'] ?></td>
                    <td><a href="index.php?model=subscriber_book&method=delete&id=<?= $subscriberBook['id'] ?>"> Delete </a>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
